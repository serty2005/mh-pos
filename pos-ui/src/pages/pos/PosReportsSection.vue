<template>
  <section class="reports-workspace section-workspace">
    <main class="section-main-surface" :aria-label="terminal.t('pos.reportsTitle')">
      ...
      <PosPanel :title="terminal.t('pos.paymentSummary')">
      ...
      <PosPanel :title="terminal.t('pos.shiftReadiness')">
    ...
    <PosActionRail :eyebrow="terminal.t('pos.currentData')" :title="terminal.t('pos.reportScope')" :aria-label="terminal.t('pos.reportScope')">
      <template #summary>
        <div>
...
import { PosActionRail, PosButton, PosMetricCard, PosPanel, PosSectionHeader, PosStatusStrip } from '../../shared/ui';
