  ...
  <q-page class="waiter-page">
        ...
        <template v-else>
          ...
          <div v-else class="waiter-order-lines">
            ...
            <article
              ...
              :class="{ selected: line.id === terminal.selectedOrderLine.value?.id }"
    ...
    <PosDialog v-model="terminal.modifierDialog.value" :title="t('pos.modifiers')" :eyebrow="terminal.modifierMenuItem.value?.name">
      <div class="waiter-modifier-list">
        <section v-for="group in terminal.modifierGroupsForDialog.value" :key="group.id" class="waiter-modifier-group">
          <div>
            ...
            <span>{{ group.required ? t('pos.requiredModifierGroup') : t('pos.optionalModifierGroup') }}</span>
          </div>
      ...
      <template #actions>
        ...
        <PosButton variant="primary" :label="t('actions.add')" :loading="terminal.addLineMutation.isPending.value" @click="terminal.submitModifierSelection" />
      </template>
    </PosDialog>
  </q-page>
</template>
