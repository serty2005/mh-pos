...
- POS cashier UI теперь вызывает full check cancellation/refund ledger endpoints для pilot-minimum acceptance; compatibility payment refund остается отдельным fallback.
