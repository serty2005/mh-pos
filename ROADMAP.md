...
- implemented now: добавить и задокументировать rate limiting для PIN attempts
...
- ������ ������ structured logging contract ��� backend ��������;
- ��������� ������ `TRACE/DEBUG/INFO/WARN/ERROR` � runtime env-��������;
- ��������� ������� masking/redaction �������������� auth-������.
...
- �������� shared helper ��� non-HTTP telemetry ������������ (`operation/action/result/error_code`);
- sync sender ������ TRACE lifecycle ���������;
- ��������� ��������� ������� `test_pipe/` ������ ��� unmanaged artifact.
