...
type KitchenProposalKind = kitchen.ProposalKind
type KitchenProposalStatus = kitchen.ProposalStatus
type KitchenProposal = kitchen.Proposal
type KitchenProposalListQuery = kitchen.ProposalListQuery
...
const (
	...
	KitchenProposalKindCatalog      = kitchen.ProposalKindCatalog
	KitchenProposalKindRecipe       = kitchen.ProposalKindRecipe
	KitchenProposalDraft            = kitchen.ProposalDraft
	KitchenProposalPendingSync      = kitchen.ProposalPendingSync
	KitchenProposalSynced           = kitchen.ProposalSynced
	KitchenProposalApproved         = kitchen.ProposalApproved
...
type StorageArchiveVerificationSummary = storage.ArchiveVerificationSummary
type StorageArchiveVerifyResult = storage.ArchiveVerifyResult
type StorageArchiveReadPlanClosedOrder = storage.ArchiveReadPlanClosedOrder
type StorageArchiveReadPlan = storage.ArchiveReadPlan
type StorageArchiveLookupKey = storage.ArchiveLookupKey
type StorageArchiveLookupDocument = storage.ArchiveLookupDocument
type StorageArchiveLookupRelatedCounts = storage.ArchiveLookupRelatedCounts
type StorageArchiveLookupPreview = storage.ArchiveLookupPreview
