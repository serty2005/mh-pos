...
func ValidateExchangeStream(streamName string) error {
	...
	case MasterDataStreamRestaurants, MasterDataStreamDevices, MasterDataStreamStaff, MasterDataStreamFloor, MasterDataStreamCatalog, MasterDataStreamMenu, MasterDataStreamPricing, MasterDataStreamRecipes, MasterDataStreamInventory, MasterDataStreamProposalFeedback, MasterDataStreamReceiptTemplates, MasterDataStreamPrinters, MasterDataStreamSalesPoints, MasterDataStreamSections:
		return nil
	default:
