...
- До первого выставочного запуска: Cloud sales dashboard/API (POS-40), Telegram worker и оставшиеся production hardening checkpoints. Ticket issuance, уникальный номер, validity snapshot, QR payload и физическая нефискальная ESC/POS печать precheck/ticket реализованы сейчас (POS-48/POS-64 P1); hardware acceptance выполнен на `10.25.1.201:9100`, операторское визуальное подтверждение бумаги фиксируется отдельно. Внешний licensing authority и gates существующих table/kitchen/warehouse surfaces реализованы сейчас; tenant-level roles/employees, memberships, tenant catalog identity и restaurant menu overrides также реализованы сейчас.
