...
- POS UI читает effective Edge entitlement snapshot и скрывает floor, KDS, warehouse stock и waiter modes при отсутствии соответствующих grants. Это UX-слой; Edge backend gates являются авторитетными. Canonical module IDs описаны в `docs/backend/LICENSE-ENTITLEMENTS.md`.
