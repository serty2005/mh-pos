...
- OLAP workspace: ClickHouse export health, backfill job state, kitchen timing summary and read-only previews for sales/stock moves; COGS/margin remain `запланировано далее` after reliable cost basis and backend/UI contracts;
