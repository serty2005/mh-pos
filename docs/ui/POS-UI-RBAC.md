...
| Kitchen stock receipt capture | `pos.kitchen.stock.receipt` | реализовано сейчас backend, UI формы запланировано далее |
| Kitchen inventory count | `pos.kitchen.stock.inventory_count` | реализовано сейчас backend, UI формы запланировано далее |
| Kitchen stock write-off | `pos.kitchen.stock.write_off` | реализовано сейчас backend, UI формы запланировано далее |
| Kitchen production completed | `pos.kitchen.production.complete` | реализовано сейчас backend, UI формы запланировано далее |
| Kitchen catalog suggestion | `pos.kitchen.catalog.suggest` | реализовано сейчас backend, UI формы запланировано далее |
| Kitchen recipe view | `pos.kitchen.recipe.view` | реализовано сейчас backend, UI экран запланировано далее |
| Kitchen recipe change suggestion | `pos.kitchen.recipe.suggest` | реализовано сейчас backend, UI формы запланировано далее |
