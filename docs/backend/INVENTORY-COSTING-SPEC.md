...
- full inventory engine beyond текущего bounded worker slice: materialized balances, production-grade receipts/counts/recalculation state, refund/cancellation dispositions, semi-finished auto-production split и retro recalculation DAG;
...
2. Полная allocation-модель для refund/cancellation disposition, semi-finished auto-production split и retro costing.
